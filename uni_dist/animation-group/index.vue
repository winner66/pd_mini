<template>
<view :class="'wux-class ' + wrapCls + ' ' + animateCss" @tap="onTap" :catchtouchmove="disableScroll ? 'noop' : ''" @transitionend="onTransitionEnd" @animationend="onAnimationEnd" v-if="animateStatus !== 'unmounted'" :style="extStyle">
    <slot></slot>
</view>
</template>
...
var _baseComponent = _interopRequireDefault(require("../helpers/baseComponent.js")),
    _styleToCssString = _interopRequireDefault(require("../helpers/styleToCssString.js"));
