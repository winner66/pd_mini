...
baseComponent({
  ...
  methods: {
    ...
    onChange(item) {
      const checkedValues = getCheckedValues(item.value, this.data.inputValue); // 如果使用 <Field /> 组件包裹时，value 返回值为数组
