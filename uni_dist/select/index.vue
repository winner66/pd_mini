<template>
<wux-popup-select id="wux-popup-select" :prefixCls="prefixCls" :value="value" :options="options" :multiple="multiple" :max="max" :toolbar="toolbar" :visible="visible" controlled disabled @cancel="onCancel" @confirm="onConfirm" @visibleChange="onVisibleChange" @valueChange="onValueChange"></wux-popup-select>
</template>
...
var _baseComponent = _interopRequireDefault(require("../helpers/baseComponent.js")),
    ...
    _utils = require("../popup-select/utils.js");
...
function runCallbacks(e, t, n) {
  var r = t.value,
      ...
      i = o.options,
      s = o.multiple,
      l = (0, _utils.getSelectIndex)(i, r, s);
  "function" == typeof n.fns[e] && n.fns[e].call(n, r, l, i);
}
